...
# inventory/urls.py 
    ...
    path('api/activites/', views.api_activites_recent, name='api_activites_recent'),
...
# Après
    ...
    # Rapport IA
    path('report_ai/', report_ai_view, name='openai_report'),
...
# Page HTML statistiques
    ...
    path('gestionnaire/demande/<int:demande_id>/<str:action>/', views.action_demande, name='action_demande'),
...
# urls.py
    path('mouvements/entree/', views.nouvelle_entree, name='nouvelle_entree'),
    path('mouvements/sortie/', views.nouvelle_sortie, name='nouvelle_sortie'),
